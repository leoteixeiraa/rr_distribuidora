...
function calcValor2(){
    //CALCULO VENDA PR
    // zerando total
    document.getElementById("venda_pr").value = '0';
    ...
    document.getElementById("venda_pr").value = '' + TOTAL.toFixed(2);
}
</script>
...
function calcValor3(){
    ...
    // zerando total
    document.getElementById("val_pr").value = '0';
 
    // valor líquido - valor do produto
    var VTOTALLIQUIDO = parseFloat(document.getElementById("preco_pr").value);
 
    // VENDA PR - venda_pr
    var VTOTALLIQUIDO2 = parseFloat(document.getElementById("venda_pr").value);
    var TOTAL = parseFloat(VTOTALLIQUIDO) * parseFloat(VTOTALLIQUIDO2);
 
    document.getElementById("val_pr").value = '' + TOTAL.toFixed(2);
}
</script>
  ...
  <center>
    <p><font face="arial" size="5" color="black"><B>Cadastro de Venda - PR</B>
    </font></p>
    <input type="text" name="preco_sc" id="preco_sc" style="display:none;" >
      ...
      <tbody>
        <tr>
          <td width="242"><strong>Funcionário: 
              <input name="funcionario" type="text" class="txt" style="margin-bottom:20px;" value="Janderson Tibes de Campos" maxlength="50" readonly>
          </strong></td>
        </tr>
      </tbody>
    </table>
    ...
    <table width="456" border="0" align="left">
      ...
      <br>
            ...
            <br>
            <br>
            <label>Preço PR   R$</label>
            <input type="text" class="form-control" id="preco_pr" name="preco_pr" onblur="calcValor3()" readonly>
            <br>
          <br></td>
        </tr>
      </tbody>
...
<div class="col-md-12">
  ...
  <label><br>
    ...
    <table width="417" height="265" border="0" cellpadding="0" cellspacing="0">
      ...
      <td width="179"><input type="text" name="carga" id="carga" onkeyup="SubstituiVirgulaPorPonto(this)" onblur="calcValor2()" required /></td>
    </tr>
    <tr>  
    ...
    <tr>
      <td class="dir"><strong>Venda PR:</strong></td>
      <td><input type="text" name="venda_pr" id="venda_pr"  onblur="calcValor2()" readonly /></td>
    </tr>
    <tr>
      <td class="dir"><p>&nbsp;</p>
        <p><strong>Valorização PR:</strong></p></td><td><p>&nbsp;
          </p>
          <p>R$
            <input type="text" name="val_pr" id="val_pr" value="0.00" onblur="calcValor3()" readonly />
          </p></td>
    <tr>
...
if(isset($_POST["submit"])){
  ...
  $sql = "INSERT INTO pagamentos (dia, mes, ano, tipo, especificacao, preco_sc, preco_pr, custo, carga, retorno, venda_pr, val_pr, recarga, carga_seguinte, funcionario, registro)
  VALUES ('".$_POST["dia"]."','".$_POST["mes"]."','".$_POST["ano"]."','".$_POST["tipo"]."','".$_POST["especificacao"]."','".$_POST["preco_sc"]."','".$_POST["preco_pr"]."','".$_POST["custo"]."','".$_POST["carga"]."','".$_POST["retorno"]."','".$_POST["venda_pr"]."','".$_POST["val_pr"]."','".$_POST["recarga"]."','".$_POST["carga_seguinte"]."','".$_POST["funcionario"]."', NOW())";
  ...
  echo "<script type= 'text/javascript'>alert('Error: " . $sql . "<br>" . $conn->error."');</script>";
    ...
    $sql = "REPLACE INTO carga_janderson (id, carga) VALUES ('".$_POST["id"]."','".$_POST["carga_seguinte"]."')";
  if ($con->query($sql) === TRUE) {
  ...
  echo "<script type= 'text/javascript'>alert('Error: " . $sql . "<br>" . $conn->error."');</script>";
    ...
    $sql2 = "INSERT INTO pagamentos_janderson (dia, mes, ano, tipo, especificacao, preco_sc, preco_pr, custo, carga, retorno, venda_pr, val_pr, recarga, carga_seguinte, funcionario, registro)
  VALUES ('".$_POST["dia"]."','".$_POST["mes"]."','".$_POST["ano"]."','".$_POST["tipo"]."','".$_POST["especificacao"]."','".$_POST["preco_sc"]."','".$_POST["preco_pr"]."','".$_POST["custo"]."','".$_POST["carga"]."','".$_POST["retorno"]."','".$_POST["venda_pr"]."','".$_POST["val_pr"]."','".$_POST["recarga"]."','".$_POST["carga_seguinte"]."','".$_POST["funcionario"]."', NOW())";
