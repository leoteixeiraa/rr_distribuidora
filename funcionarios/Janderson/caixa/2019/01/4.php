...
<center>
  <table id="tabela" class="display" cellspacing="0" width="100%">
    ...
    $query = "SELECT tipo, SUM(val_sc), SUM(val_pr), SUM(val_sc)+SUM(val_pr) as vendas_total FROM pagamentos_janderson where dia=('04') and mes=('01') and ano=('2019') GROUP BY tipo"; 
