...
<table width="539" border="0" align="left">
  <tbody>
    <tr>
      <td width="533" align="center" style="font-size: 35px; font-family: Consolas, 'Andale Mono', 'Lucida Console', 'Lucida Sans Typewriter', Monaco, 'Courier New', monospace;"><strong>Bem-Vindo, Lucas Lins!</strong></td>
    </tr>
  </tbody>
</table>
<?php
