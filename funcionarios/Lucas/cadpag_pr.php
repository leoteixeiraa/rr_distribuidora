      ...
      <tbody>
        <tr>
          <td width="242"><strong>Funcionário: 
              <input name="funcionario" type="text" class="txt" style="margin-bottom:20px;" value="Lucas Lins" maxlength="50" readonly>
          </strong></td>
        </tr>
      </tbody>
    </table>
...
if(isset($_POST["submit"])){
  ...
  echo "<script type= 'text/javascript'>alert('Error: " . $sql . "<br>" . $conn->error."');</script>";
    ...
    $sql = "REPLACE INTO carga_lucas (id, carga) VALUES ('".$_POST["id"]."','".$_POST["carga_seguinte"]."')";
  if ($con->query($sql) === TRUE) {
  ...
  echo "<script type= 'text/javascript'>alert('Error: " . $sql . "<br>" . $conn->error."');</script>";
    ...
    $sql2 = "INSERT INTO pagamentos_lucas (dia, mes, ano, tipo, especificacao, preco_sc, preco_pr, custo, carga, retorno, venda_pr, val_pr, recarga, carga_seguinte, funcionario, registro)
  VALUES ('".$_POST["dia"]."','".$_POST["mes"]."','".$_POST["ano"]."','".$_POST["tipo"]."','".$_POST["especificacao"]."','".$_POST["preco_sc"]."','".$_POST["preco_pr"]."','".$_POST["custo"]."','".$_POST["carga"]."','".$_POST["retorno"]."','".$_POST["venda_pr"]."','".$_POST["val_pr"]."','".$_POST["recarga"]."','".$_POST["carga_seguinte"]."','".$_POST["funcionario"]."', NOW())";
