...
<center>
  <table id="tabela" class="display" cellspacing="0" width="100%">
    ...
    $query = "SELECT tipo, SUM(val_sc), SUM(val_pr), SUM(val_sc)+SUM(val_pr) as vendas_total FROM pagamentos_gustavo where dia=('15') and mes=('12') and ano=('2019') GROUP BY tipo"; 
