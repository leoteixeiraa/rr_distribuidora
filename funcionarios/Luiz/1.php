...
<center>
	<table id="tabela" class="display" cellspacing="0" width="100%">
		...
		$query = "SELECT tipo, SUM(val_sc), SUM(val_pr), SUM(val_sc)+SUM(val_pr) as vendas_total FROM pagamentos_luiz where dia=('01') and mes=('11') and ano=('2018') GROUP BY tipo"; 
    ...
    $total = 0;
     ...
     $total_produtos = " Total R$: " ;
	    ...
	    <?php
	    	$query2 = "SELECT entrada_saida FROM caixa_luiz ORDER BY entrada_saida DESC LIMIT 1";
	   ...
	   <?php
	   		$query3 = "SELECT saldo_promissoria FROM caixa_luiz ORDER BY saldo_promissoria DESC LIMIT 1";
...
-->
<input type="text" name="dia" id="dia" style="display:none;" value="01">
<input type="text" name="mes" id="mes" style="display:none;" value="11">
<input type="text" name="ano" id="ano" style="display:none;" value="2018">
<input type="text" name="funcionario" id="funcionario" style="display:none;" value="Luiz Henrique">
  ...
  <tbody>
    <tr>
      ...
      <td width="68%" bgcolor="#FFFF00"><strong>R$</strong>
        <input type="text" name="promissoria_dia" id="promissoria_dia" value="0" onkeyup="SubstituiVirgulaPorPonto(this)" onblur="calcValor4()" ></td>
    </tr>
    <tr>
      ...
      <input type="text" name="promissoria_cobrar" id="promissoria_cobrar" value="0" onkeyup="SubstituiVirgulaPorPonto(this)" onblur="calcValor4()"  ></td>
    </tr>
    <tr>
      ...
      <td><strong>R$</strong>
        <input type="text" name="total_entrada" id="total_entrada" onblur="calcValor();calcValor3();" readonly onkeyup="SubstituiVirgulaPorPonto(this)" ></td>
    </tr>
   </tbody>
</table>
...
<table width="37%" height="555" border="0" align="center">
  <tbody>
    ...
    <tr>
      ...
      <td bgcolor="#FFFF00"><strong>R$</strong>
        <input type="text" name="oficina" id="oficina" value="0" onblur="calcValor2()" onkeyup="SubstituiVirgulaPorPonto(this)" ></td>
    </tr>
    <tr>
...
<table width="37%" height="260" border="0" align="center">
  <tbody>
    ...
    <tr>
      ...
      <td bgcolor="#FFFF00"><strong>R$</strong>
      <input type="text" name="vale_funcionario" id="vale_funcionario" value="0" onblur="calcValor2()" onkeyup="SubstituiVirgulaPorPonto(this)" ></td>
    </tr>
    <tr>
      ...
      <td bgcolor="#FFFF00"><strong>R$</strong>
      <input type="text" name="furo_caixa" id="furo_caixa" value="0" onblur="calcValor2()" onkeyup="SubstituiVirgulaPorPonto(this)" ></td>
    </tr>
    <tr>
  ...
  <tbody>
    <tr>
      ...
      <td><p><strong>R$</strong>
        <input type="text" name="total_saida" id="total_saida" onblur="calcValor();calcValor3(this);" readonly onkeyup="SubstituiVirgulaPorPonto(this)" ></td>
    </tr>
    <tr>
      ...
      <td><strong>R$</strong>
        <input type="text" name="entrada_saida" id="entrada_saida" readonly onblur="calcValor3()" onkeyup="SubstituiVirgulaPorPonto(this)" ></td>
    </tr>
    <tr>
...
<table width="37%" height="133" border="0" align="center">
  <tr bgcolor="#FFFF00">
    ...
    <td><strong>R$</strong>
    <input type="text" name="promissoria_soma" id="promissoria_soma" value="0" onkeyup="SubstituiVirgulaPorPonto(this)" onblur="calcValor4()" ></td>
  </tr>
  <tbody>
    <tr>
      ...
      <td><strong>R$</strong>
        <input type="text" name="soma" id="soma" onkeyup="SubstituiVirgulaPorPonto(this)" onblur="calcValor4()" ></td>
    </tr>
    <tr>
      ...
      <td><strong>R$</strong>
        <input type="text" name="falta_sobra" id="falta_sobra" onkeyup="SubstituiVirgulaPorPonto(this)" onblur="calcValor4()" ></td>
    </tr>
  </tbody>
</table>
<p>
...
<textarea rows="8" cols="45" style="border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px" id="total_produtos" name="total_produtos"><?php 

echo $produtos ?>

<?php echo $total_produtos ?></textarea></td>
<td width="220">&nbsp;</td>
</tr>
...
if(isset($_POST["submit"])){
  ...
  $sql2 = "INSERT INTO caixa_luiz (dia, mes, ano, saldo_anterior, vendas_dia, total_produtos, cheque_devolvido1, cheque_devolvido2, promissoria_dia, promissoria_cobrar, total_entrada, almoco, combustivel, hotel, deposito, oficina, despesa6, despesa7, despesa8, despesa9, espc_despesa, cheque, dinheiro, vale_funcionario, furo_caixa, saida5, espc_saidas, total_saida, entrada_saida, saldo_promissoria, soma, falta_sobra, funcionario, registro)
  VALUES ('".$_POST["dia"]."','".$_POST["mes"]."','".$_POST["ano"]."','".$_POST["saldo_anterior"]."','".$_POST["vendas_dia"]."','".$_POST["total_produtos"]."','".$_POST["cheque_devolvido1"]."','".$_POST["cheque_devolvido2"]."','".$_POST["promissoria_dia"]."','".$_POST["promissoria_cobrar"]."','".$_POST["total_entrada"]."','".$_POST["almoco"]."','".$_POST["combustivel"]."','".$_POST["hotel"]."','".$_POST["deposito"]."','".$_POST["oficina"]."','".$_POST["despesa6"]."','".$_POST["despesa7"]."','".$_POST["despesa8"]."','".$_POST["despesa9"]."','".$_POST["espc_despesa"]."','".$_POST["cheque"]."','".$_POST["dinheiro"]."','".$_POST["vale_funcionario"]."','".$_POST["furo_caixa"]."','".$_POST["saida5"]."','".$_POST["espc_saidas"]."','".$_POST["total_saida"]."','".$_POST["entrada_saida"]."','".$_POST["saldo_promissoria"]."','".$_POST["soma"]."','".$_POST["falta_sobra"]."','".$_POST["funcionario"]."', NOW())";
