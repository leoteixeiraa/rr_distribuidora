...
if(isset($_POST["submit"])){
  ...
  $sql = "UPDATE `fornecedores` SET especificacao='".$_POST['especificacao']."',preco_sc='".$_POST['preco_sc']."',preco_pr='".$_POST['preco_pr']."',tipo='".$_POST['tipo']."',obs='".$_POST['obs']."' WHERE id='".$_POST['id']."'";
