...
<center>
  <table id="tabela" class="display" cellspacing="0" width="100%">
    ...
    $query = "SELECT tipo, SUM(val_sc), SUM(val_pr), SUM(val_sc)+SUM(val_pr) as vendas_total FROM pagamentos_luiz where dia=('07') and mes=('11') and ano=('2018') GROUP BY tipo"; 
...
-->
<input type="text" name="dia" id="dia" style="display:none;" value="07">
