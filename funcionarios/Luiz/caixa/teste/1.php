...
<center>
	<table id="tabela" class="display" cellspacing="0" width="100%">
		...
		$query = "SELECT tipo, SUM(val_sc) FROM pagamentos where (dia= '1') and (mes= '10') and (ano= '2018') GROUP BY tipo"; 
    ...
    $total = 0;
	    ...
	    <?php
	    	$query2 = "SELECT entrada_saida FROM caixa ORDER BY entrada_saida DESC LIMIT 1";
	   ...
	   <?php
	   		$query3 = "SELECT saldo_promissoria FROM caixa ORDER BY saldo_promissoria DESC LIMIT 1";
...
<input type="text" name="funcionario" id="funcionario" style="display:none;" value="Administrador">
...
if(isset($_POST["submit"])){
  ...
  $sql = "INSERT INTO caixa (dia, mes, ano, saldo_anterior, vendas_dia, cheque_devolvido1, cheque_devolvido2, promissoria_dia, promissoria_cobrar, total_entrada, almoco, combustivel, hotel, deposito, despesa5, despesa6, despesa7, despesa8, despesa9, espc_despesa, cheque, dinheiro, saida3, saida4, saida5, espc_saidas, total_saida, entrada_saida, saldo_promissoria, promissoria_soma, soma, falta_sobra, funcionario, registro)
  VALUES ('".$_POST["dia"]."','".$_POST["mes"]."','".$_POST["ano"]."','".$_POST["saldo_anterior"]."','".$_POST["vendas_dia"]."','".$_POST["cheque_devolvido1"]."','".$_POST["cheque_devolvido2"]."','".$_POST["promissoria_dia"]."','".$_POST["promissoria_cobrar"]."','".$_POST["total_entrada"]."','".$_POST["almoco"]."','".$_POST["combustivel"]."','".$_POST["hotel"]."','".$_POST["deposito"]."','".$_POST["despesa5"]."','".$_POST["despesa6"]."','".$_POST["despesa7"]."','".$_POST["despesa8"]."','".$_POST["despesa9"]."','".$_POST["espc_despesa"]."','".$_POST["cheque"]."','".$_POST["dinheiro"]."','".$_POST["saida3"]."','".$_POST["saida4"]."','".$_POST["saida5"]."','".$_POST["espc_saidas"]."','".$_POST["total_saida"]."','".$_POST["entrada_saida"]."','".$_POST["saldo_promissoria"]."','".$_POST["promissoria_soma"]."','".$_POST["soma"]."','".$_POST["falta_sobra"]."','".$_POST["funcionario"]."', NOW())";
