...
<table width="411" height="75" border="0" align="center">
  <tbody>
    <tr>
      <td width="459" align="center" valign="middle" style="font-weight: 400; font-family: Cambria, 'Hoefler Text', 'Liberation Serif', Times, 'Times New Roman', serif; font-size: 45px;"><strong>Carga Emerson</strong></td>
    </tr>
  </tbody>
</table>
<p>&nbsp;</p>
...
if(isset($_POST["submit"])){
    $sql = "REPLACE INTO carga_emerson (id, carga) VALUES ('".$_POST["id"]."','".$_POST["carga"]."')";
