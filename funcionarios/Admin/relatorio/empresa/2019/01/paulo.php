...
<?php
  ...
  //SACOLAS
    $query = "SELECT tipo, SUM(val_sc), SUM(val_pr), SUM(val_sc)+SUM(val_pr) as vendas_total FROM pagamentos_paulo where tipo=('Sacolas') and (dia >='01' and dia <='31') and mes=('01') and ano=('2019') GROUP BY tipo"; 
   
    $result = mysql_query($query) or die(mysql_error());
  
  //ISQUEIRO
   $query2 = "SELECT tipo, SUM(val_sc), SUM(val_pr), SUM(val_sc)+SUM(val_pr) as vendas_total FROM pagamentos_paulo where tipo=('Isqueiro') and (dia >='01' and dia <='31') and mes=('01') and ano=('2019') GROUP BY tipo"; 

  $result2 = mysql_query($query2) or die(mysql_error());

   //Fermento
   $query3 = "SELECT tipo, SUM(val_sc), SUM(val_pr), SUM(val_sc)+SUM(val_pr) as vendas_total FROM pagamentos_paulo where tipo=('Fermento') and (dia >='01' and dia <='31') and mes=('01') and ano=('2019') GROUP BY tipo"; 

     $result3 = mysql_query($query3) or die(mysql_error());

   //Copos
  $query4 = "SELECT tipo, SUM(val_sc), SUM(val_pr), SUM(val_sc)+SUM(val_pr) as vendas_total FROM pagamentos_paulo where tipo=('Copos') and (dia >='01' and dia <=31) and mes=('11') and ano=('2018') GROUP BY tipo"; 

    $result4 = mysql_query($query4) or die(mysql_error());

   //Guardanapo
  $query5 = "SELECT tipo, SUM(val_sc), SUM(val_pr), SUM(val_sc)+SUM(val_pr) as vendas_total FROM pagamentos_paulo where tipo=('Guardanapo') and (dia >='01' and dia <='31') and mes=('01') and ano=('2019') GROUP BY tipo"; 

   $result5 = mysql_query($query5) or die(mysql_error());

    //Cigarro
    $query6 = "SELECT tipo, SUM(val_sc), SUM(val_pr), SUM(val_sc)+SUM(val_pr) as vendas_total FROM pagamentos_paulo where tipo=('Cigarro') and (dia >='01' and dia <='31') and mes=('01') and ano=('2019') GROUP BY tipo"; 

    $result6 = mysql_query($query6) or die(mysql_error());
        
    //Cigarro_nacional
    $query7 = "SELECT tipo, SUM(val_sc), SUM(val_pr), SUM(val_sc)+SUM(val_pr) as vendas_total FROM pagamentos_paulo where tipo=('Cigarro Nacional') and (dia >='01' and dia <'=31') and mes=('11') and ano=('2018') GROUP BY tipo"; 

    $result7 = mysql_query($query7) or die(mysql_error());
      
        //Sacola Plastica
    $query8 = "SELECT tipo, SUM(val_sc), SUM(val_pr), SUM(val_sc)+SUM(val_pr) as vendas_total FROM pagamentos_paulo where tipo=('Sacola Plastica') and (dia >='01' and dia <='31') and mes=('01') and ano=('2019') GROUP BY tipo"; 

    $result8 = mysql_query($query8) or die(mysql_error());
        
        //Saco de Lixo
        $query9 = "SELECT tipo, SUM(val_sc), SUM(val_pr), SUM(val_sc)+SUM(val_pr) as vendas_total FROM pagamentos_paulo where tipo=('Saco de Lixo') and (dia >='01' and dia <='31') and mes=('01') and ano=('2019') GROUP BY tipo"; 

        $result9 = mysql_query($query9) or die(mysql_error());
      
      //Baralho
       $query10 = "SELECT tipo, SUM(val_sc), SUM(val_pr), SUM(val_sc)+SUM(val_pr) as vendas_total FROM pagamentos_paulo where tipo=('Baralho') and (dia >='01' and dia <='31') and mes=('01') and ano=('2019') GROUP BY tipo"; 

       $result10 = mysql_query($query10) or die(mysql_error());
      
      //Canudos
       $query11 = "SELECT tipo, SUM(val_sc), SUM(val_pr), SUM(val_sc)+SUM(val_pr) as vendas_total FROM pagamentos_paulo where tipo=('Canudos') and (dia >='01' and dia <='31') and mes=('01') and ano=('2019') GROUP BY tipo"; 

       $result11 = mysql_query($query11) or die(mysql_error());
      
      //Kraft
       $query12 = "SELECT tipo, SUM(val_sc), SUM(val_pr), SUM(val_sc)+SUM(val_pr) as vendas_total FROM pagamentos_paulo where tipo=('Kraft') and (dia >='01' and dia <='31') and mes=('01') and ano=('2019') GROUP BY tipo"; 

       $result12 = mysql_query($query12) or die(mysql_error());      
      
      //Pedra sanitaria
       $query13 = "SELECT tipo, SUM(val_sc), SUM(val_pr), SUM(val_sc)+SUM(val_pr) as vendas_total FROM pagamentos_paulo where tipo=('Pedra Sanitaria') and (dia >='01' and dia <='31') and mes=('01') and ano=('2019') GROUP BY tipo"; 

       $result13 = mysql_query($query13) or die(mysql_error());
     
      //Luvas Sanro
       $query14 = "SELECT tipo, SUM(val_sc), SUM(val_pr), SUM(val_sc)+SUM(val_pr) as vendas_total FROM pagamentos_paulo where tipo=('Luvas Sanro') and (dia >='01' and dia <='31') and mes=('01') and ano=('2019') GROUP BY tipo"; 

       $result14 = mysql_query($query14) or die(mysql_error()); 
      
      //Outros
       $query15 = "SELECT tipo, SUM(val_sc), SUM(val_pr), SUM(val_sc)+SUM(val_pr) as vendas_total FROM pagamentos_paulo where tipo=('Outros') and (dia >='01' and dia <='31') and mes=('01') and ano=('2019') GROUP BY tipo"; 
   ...
   //--------------------------------------------- DESCONTOS e DESPESAS --------------------------------------------------------//
       ...
       $query16 = "SELECT SUM(almoco) as total_almoco, " .
                  ...
                  "FROM caixa_paulo where (dia >='01' and dia <='31') and mes=('01') and ano=('2019')";

       $result16 = mysql_query($query16) or die(mysql_error());

       // //Total dinheiro
       // $query17 = "SELECT SUM(dinheiro) as total_dinheiro FROM caixa_paulo where (dia >='01' and dia <='31') and mes=('01') and ano=('2019')";

       // $result17 = mysql_query($query17) or die(mysql_error());

       // //Vale Funcionario
       // $query18 = "SELECT SUM(vale_funcionario) as total_vale_funcionario FROM caixa_paulo where (dia >='01' and dia <='31') and mes=('01') and ano=('2019')";
       // $result18 = mysql_query($query18) or die(mysql_error());

       // //furo caixa
       // $query19 = "SELECT SUM(furo_caixa) as total_furocaixa FROM caixa_paulo where (dia >='01' and dia <='31') and mes=('01') and ano=('2019')";
       // $result19 = mysql_query($query19) or die(mysql_error());

       // // SAIDA 5
       // $query20 = "SELECT SUM(saida5) as total_saida5 FROM caixa_paulo where (dia >='01' and dia <='31') and mes=('01') and ano=('2019')";
    ...
    $despesa9 = 0;
      ...
      while($row = mysql_fetch_array($result3)){
        ...
        $vendas_total2 = number_format($vendas_total, 2, ',','.');
         ...
         $total_despesa_paulo0 = $total_despesa;
         $total_despesa2 = number_format($total_despesa, 2, ',','.');
         $total_despesa_paulo = number_format($total_despesa, 2, ',','.');
