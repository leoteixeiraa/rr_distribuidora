...
SUM(CASE WHEN funcionario = 'Paulo' THEN venda_sc END) venda_sc_paulo
	FROM pagamentos where (dia >='01' and dia <='31') and mes=('11') and ano=('2018') GROUP BY especificacao";
...
<body>
	...
	<table width="200" border="0" align="center">
	  <tbody>
	    <tr>
	      <td align="center" valign="middle"><span class="title" style="font-size: 16px">Mês de Novembro</span></td>
        </tr>
      </tbody>
</table>
	<table align="center" class="data-table">
	  ...
	  <tbody>
		...
		while ($row = mysqli_fetch_array($query))
		{
			...
			$despesas_total = number_format($despesas_total0, 2, ',','.');
			//LIQUIDO TOTAL
    ...
    <table width="1012" height="431" border="1" align="center">
      <tbody>
        ...
        <tr>
          ...
          <td bgcolor="#e5f5ff">R$ <?php echo $despesas_total; ?></td>
