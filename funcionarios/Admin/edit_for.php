...
<?php
  ...
  <div class="col-md-12">
      <div class="col-md-6">
        ...
        <input type="text" name="preco_sc" id="Preco2" class="txt" maxlength="50" value="'.$row['preco_sc'].'">
      </div>
      </div>
      ...
      <div class="col-md-6">
        ...
        <input type="text" name="preco_pr" class="txt" id="Preco3" maxlength="30" value="'.$row['preco_pr'].'"><br>
      </div>
  </div>    
