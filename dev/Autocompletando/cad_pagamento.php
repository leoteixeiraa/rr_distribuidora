      ...
      <tbody>
        <tr>
          <td height="176"><label>Digite o ID do Produto</label>
            ...
            <input type="text" class="form-control" id="preco_sc" name="preco_sc" onblur="calcValor3()">
            <br>
          <br></td>
        </tr>
      </tbody>
...
<div class="col-md-12">
  ...
  <label><br>
    ...
    <p>&nbsp;    </p>
    <p>Observações:
  <textarea name="obs" rows="2" onfocus="this.value='';" style="font-size:30px; font-family:Times New Roman;color:red;white-space:pre-wrap;width:100%;margin-bottom:20px;"></textarea>
    </p>
</div>
...
if(isset($_POST["submit"])){
  ...
  $sql = "INSERT INTO pagamentos (dia, mes, ano, tipo_produto, especificacao, tipo_venda, quantidade, valor1, comissao1, comissao2, valor, obs, funcionario)
  VALUES ('".$_POST["dia"]."','".$_POST["mes"]."','".$_POST["ano"]."','".$_POST["tipo_produto"]."','".$_POST["especificacao"]."','".$_POST["tipo_venda"]."','".$_POST["quantidade"]."','".$_POST["valor1"]."','".$_POST["comissao1"]."','".$_POST["comissao2"]."','".$_POST["valor"]."','".$_POST["obs"]."','".$_POST["funcionario"]."')";

  if ($con->query($sql) === TRUE) {
  echo "<script type= 'text/javascript'>alert('Venda cadastrada com sucesso! Atualize o estoque');</script>";
  } else {
